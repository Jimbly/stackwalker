...
if (args.nolint) {
  ...
  gulp.task('build_deps', gulp.parallel('eslint', gulp.parallel(...build_misc_nolint, 'client_js')));
  gulp.task('watch_deps', gulp.parallel('eslint', gulp.parallel(...build_misc_nolint, 'client_js_watch')));
}
